...
!-----------------------------------------------------------------------
      ...
      integer erestrictx,erestrictu,erestrictxi
     ...
     & erestrictui_small,err)
      call ceedelemrestrictioncreateidentity(ceed,nelem,q*scale,q*nelem*scale,&
     & 1,erestrictui_large,err)
...
! Small operator
     ...
     & op_mass_small,err)
      ...
      call ceedoperatorsetfield(op_setup_small,'_weight',erestrictxi,&
     & ceed_notranspose,bx_small,ceed_vector_none,err)
      call ceedoperatorsetfield(op_setup_small,'x',erestrictx,&
     & ceed_notranspose,bx_small,ceed_vector_active,err)
     ...
     & ceed_notranspose,ceed_basis_collocated,qdata_small,err)
      call ceedoperatorsetfield(op_mass_small,'u',erestrictu,&
     & ceed_transpose,bu_small,ceed_vector_active,err)
...
! Large operator
     ...
     & op_mass_large,err)
      ...
      call ceedoperatorsetfield(op_setup_large,'_weight',erestrictxi,&
     & ceed_notranspose,bx_large,ceed_vector_none,err)
      call ceedoperatorsetfield(op_setup_large,'x',erestrictx,&
     & ceed_notranspose,bx_large,ceed_vector_active,err)
     ...
     & ceed_notranspose,ceed_basis_collocated,qdata_large,err)
      call ceedoperatorsetfield(op_mass_large,'u',erestrictu,&
     & ceed_transpose,bu_large,ceed_vector_active,err)
